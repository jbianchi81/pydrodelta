...
class PersistenceTest(TestCase):
    def test_store_restore(self):
        ...
        plan_0 = Plan.load("%s/sample_data/plans/linear_channel_dummy.yml" % os.environ["PYDRODELTA_DIR"], s3_config = {
            "url": "play.min.io",
        ...
        plan_1 = Plan.load("%s/sample_data/plans/linear_channel_dummy.yml" % os.environ["PYDRODELTA_DIR"], s3_config = {
            "url": "play.min.io",
            "access_key": "Q3AM3UQ867SPQQA43P2F",
            "secret_key": "zuf+tfteSlswRu7BJ86wekitnifILbZam1KYY3TG",
            "bucket_name": bucket_name
